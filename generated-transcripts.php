 ...
 * and we cap at 48 rows per page.
 */
                            ...
                            ?>
                                <?php foreach ($pages as $pageIndex => $resultsByPeriod): ?>
                                    <div class="transcript-container" id="<?= $enroll . '-' . ($pageIndex + 1) ?>"
                                        style="display: flex;flex-direction: column;border: 3px solid #06355f;width: 21cm !important;height: 29.7cm !important;padding: 0.8cm 2cm 2.1cm 2cm !important;font-family: calibri, sans-serif !important;background: url(../images/bc.jpg);background-position: center;background-size: cover;">
                                        <div class="marksheet" style="margin-top:3.4cm;">

                                            <?php if ($pageIndex === 0): ?>
                                                <!-- Heading on FIRST PAGE -->
                                                <div class="d-flex w-100 justify-content-end">
                                                    <h4
                                                        style="font-family: calibri, sans-serif !important;font-size: 12pt;font-weight: bold;text-align: center;width:100%; margin: 0">
                                                        TRANSCRIPT</h4>
                                                </div>

                                                <!-- Student Info Table ONLY ON FIRST PAGE -->
                                                <table class="w-100 text-start" style="margin-top:0.5cm;margin-bottom:0.5cm;">
                                                    <tr>
                                                        <td class="text-start border"
                                                            style="height:0.6cm;padding:0 0 0 5px;font-family: calibri, sans-serif !important;font-size:9pt;border-color:#111 !important;vertical-align:bottom !important;font-weight:bold;">
                                                            Name of Candidate
                                                        </td>
                                                        <td class="text-start border"
                                                            style="height:0.6cm;padding:0 0 0 5px;font-family: calibri, sans-serif !important;font-size:9pt;border-color:#111 !important;vertical-align:bottom !important;">
                                                            <?= $info['student_name'] ?>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="text-start border"
                                                            style="height:0.6cm;padding:0 0 0 5px;font-family: calibri, sans-serif !important;font-size:8pt;border-color:#111 !important;vertical-align:bottom !important;font-weight:bold;">
                                            ...
                                            <table class="table table-bordered table-marks mb-0 w-100">
                                                <?php if ($pageIndex === 0): ?>
                                                    <thead>
                                                        <tr>
                                                            <th rowspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;width:2cm;height:1.1cm;border:1px solid #111 !important;">
                                                                Subject Code</th>
                                                            <th rowspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;width:8cm;height:1.1cm;">
                                                                Subjects</th>
                                                            <th colspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;">
                                                                External<br>Marks</th>
                                                            <th colspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;">
                                                                Internal<br>Marks</th>
                                                            <th rowspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;height:1.1cm;">
                                                                Total Marks<br>OBTD</th>
                                                            <th rowspan="2"
                                                                style="font-family: calibri, sans-serif !important;font-size:9pt;font-weight:bold;height:1.1cm;">
                                                                Result/Remark</th>
                                                        </tr>
                                                        <tr>
                                                            <th
                                                                style="font-family: calibri, sans-serif !important;font-size:8pt;font-weight:bold;line-height:normal;">
                                                                MAX</th>
                                                            <th
                                                                style="font-family: calibri, sans-serif !important;font-size:8pt;font-weight:bold;line-height:normal;">
                                                                OBTD</th>
                                                    ...
                                                    <?php foreach ($resultsByPeriod as $period => $pdata): ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="8" class="text-start"
                                                                style="font-weight:bold;font-family: calibri, sans-serif !important;font-size:8.5pt;padding-left:5px;border:1px solid #111 !important;">
                                                        ...
                                                        <?php foreach ($subjects as $sub): ?>
                                                            <tr>
                                                                <td class="text-start"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;padding-left:5px;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_code'] ?></td>
                                                                <td class="text-start"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;padding-left:5px;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_name'] ?></td>
                                                                ...
                                                                <td class="text-center"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_ext_max'] ?></td>
                                                                <td class="text-center"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_ext_obt'] ?></td>
                                                                ...
                                                                <td class="text-center"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_total_obt'] ?></td>
                                                                <td class="text-start"
                                                                    style="font-family: calibri, sans-serif !important;font-size:8.5pt;padding-left:5px;border:1px solid #111 !important;">
                                                                    <?= $sub['sub_result_remark'] ?></td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                <?= $totals['Ext_max_total'] ?></td>
                                                            <td
                                                                style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                <?= $totals['Ext_max_obt_total'] ?></td>
                                                            <td
                                                                style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                <?= $totals['int_max_total'] ?></td>
                                                            <td
                                                                style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                <?= $totals['int_max_obt_total'] ?></td>
                                                            <td
                                                                style="font-weight:bold;font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                                <?= $totals['total_obt'] ?></td>
                                                            <td
                                                                style="font-family: calibri, sans-serif !important;font-size:8.5pt;border:1px solid #111 !important;">
                                                            </td>
                                            ...
                                            <?php if ($pageIndex === $lastPageIndex): ?>
                                                ...
                                                <table class="w-100 text-start" style="margin-top:0.1cm;">
                                                    <tr>
                                                        <td class="text-start border"
                                                            style="font-weight:bold;padding: 0 !important;border: none !important;width: 2.5cm;">
                                                            Grand Total</td>
                                                        <td class="text-start border"
                                                            style="font-weight:bold;padding: 0 !important;border: none !important;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start border"
                                                            style="font-weight:bold;padding: 0 !important;border: none !important;">
                                                            : <?= number_format($info['percentage'], 2) ?>% </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-start border"
                                                            style="font-weight:bold;padding: 0 !important;border: none !important;width: 2.5cm;">
                                        ...
                                        <?php if ($pageIndex === $lastPageIndex): ?>
                                            <p style="font-weight:bold;margin-bottom:0;margin-top: auto;margin-left: auto;">
