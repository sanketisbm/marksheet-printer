...
<body>
                    ...
                    <div class="card overflow-hidden p-4" style="height: 80vh">
                        ...
                        <div class="row justify-content-between mb-4 mx-0">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button class="btn btn-primary mdi mdi-file-send get-provisional-certificate" tabindex="0"
                                    aria-controls="provisionalCertificateTableTable" type="button" data-bs-toggle="tooltip"
                        ...
                        <div class="card-body p-0" id="provisionalCertificateTable">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody id="provisionalCertificateTableBody"></tbody>
                                </table>
                            </div>
                        </div>
    ...
    <script>
        ...
        var scrollbar1 = document.getElementById("provisionalCertificateTable");
        if (scrollbar1) {
        ...
        function fetch_data_tLeads(dateRange) {
            var tableBody = $("#provisionalCertificateTableBody");
            $('#entries').empty();
            $('#entries').text(0);
            tableBody.empty();
            $.ajax({
                ...
                success: function(response) {
                    if (response && response.result && Array.isArray(response.result)) {
                        ...
                        const tableBody = $("#provisionalCertificateTable tbody");
                        tableBody.empty();
                        ...
                        $("#provisionalCertificateTable tbody").on("click", "tr", function() {
                            $("#provisionalCertificateTable tbody tr").removeClass("selected-row");
        ...
        $(".get-provisional-certificate").on("click", function() {
            let checkedValues = [];
            ...
            window.location.href = "generated-provisional-certificates?param=" + checkedValues.join(',');
        });

        $(".download-csv").on("click", function() {
            downloadCSV2("#provisionalCertificateTableBody", "Transcript Data.csv");
            alert("Your data has been downloaded.");
        });

        $(document).on("click", "#provisionalCertificateTable tbody tr .trash", function() {
        ...
        $(document).ready(function() {
            $('#searchInput').on('keyup', function() {
                ...
                $('#provisional_certificateTableBody tr').filter(function() {
