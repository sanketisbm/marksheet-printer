...
function unicode_to_krutidev($text)
{
    ...
    $text = preg_replace_callback('/र्([क-ह][़]?)/u', function ($m) {
        return $m[1] . "Z";
    }, $text);

    // 2) Reorder "ि" (pre-base vowel)
    // ex: कि (क + ि) => fक (Kruti style)
    // also handles conjuncts like "क्ति"
    $text = preg_replace('/([क-ह][़]?)(्[क-ह][़]?)*ि/u', 'f$1$2', $text);
...
>>>>>>> 2005174387a2c695c68739eea77d766ae53492cf
