...
<div class="marksheet mb-0 margin-0-5" style="margin-top:0.5cm;width: 18.92cm !important;">
    <div class="subject-info text-center">
        ...
        <?php if ($program_print_name === "Master in Business Administration") {
    ...
    <table class="mb-2 w-100 font-11pt m-2-space text-start <?php echo $topSpacing ?>" style="width: 18.92cm !important;">
        <tr>
            <td class="pn-col-1 text-start">Name of Student</td>
            <td class="text-start fw-bold">: <?php echo  $student_name ?></td>
        </tr>
        <tr>
            <td class="pn-col-1 text-start">Father’s/Husband’s Name</td>
            <td class="text-start fw-bold">: <?php echo  $father_name ?></td>
        </tr>
        <tr>
            <td class="pn-col-1 text-start">Enrollment No</td>
            <td class="text-start fw-bold">: <?php echo  $enrollment_no ?></td>
        </tr>
        <tr>
            <td class="pn-col-1 text-start">Roll No</td>
            <td class="text-start fw-bold">: <?php echo  $roll_no ?></td>
        </tr>
    </table>
        ...
        <thead>
            <tr>
                ...
                <?php for ($i = 1; $i <= $subCount; $i++) { ?>
                    <th class="h-0-5 font-10pt <?php echo  $semNoClass ?>">
        ...
        <tr>
            <td style="padding: 0.1cm 0 0 0; display:flex; flex-direction: column;">
                <table style="width: 17.21cm !important;">
                    <tr>
                        <td class="font-11pt text-start fw-bold" style="border:0 !important;padding: 0 0 5px 0 !important;width: 100%;">
