...
?>
    <div class="doc-container" id="<?= htmlspecialchars($info['enrollment_no']) ?>">
        <div style="margin-top:4.8cm; display: flex; flex-direction:column;">
            ...
            <p style="margin-top: 1.5cm;font-size: 12pt;width:17cm">
                Enrollment No:- <?= htmlspecialchars($resultData['enrollment_no'] ?? $info['enrollment_no'] ?? '-') ?>
            </p>

            <p class="text-center"
                style="margin-top: 2.5cm;font-size: 18pt;font-weight: bold;text-decoration: underline;width:17cm">
                PROVISIONAL CERTIFICATE
            </p>

            <p style="font-size: 16pt;line-height:  calc(2 * 1em + 5pt);margin-top:1.7cm;width:17cm;word-spacing: 10px;text-indent:1.27cm;">It has been certified that Mr. / Mrs. /
                ...
                receive the Degree of <?= htmlspecialchars($resultData['program'] ?? $info['program'] ?? '-') ?>, having
            ...
            <p style="text-align:right;font-size:14pt;font-weight:400;margin-top:5.8cm;width:17cm;">
