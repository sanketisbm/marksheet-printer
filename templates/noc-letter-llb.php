...
?>
    <div class="doc-container" id="<?= htmlspecialchars($info['enrollment_no']) ?>" style="padding-left: 2.2cm !important;padding-right: 2.2cm !important;font-family: 'Times New Roman', Times, serif !important;">
        <div style="margin-top:5.8cm; display: flex; flex-direction:column;">
            <table style="width:16.4cm;">
                <tr>
                    <td style="border:none !important;padding: 0 !important;font-size:12pt;font-weight:400;text-align: left !important;">
                        <?= htmlspecialchars($info['doc_no'] ?? $sl_no) ?>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="border:none !important;font-size: 14pt;line-height: 1.15;padding-top:1.7cm;text-align: justify !important;text-indent:1.27cm;">
                        ...
                        <?= htmlspecialchars($info['passing_year'] ?? '-') ?> with first division.</td>
                </tr>
                <tr>
            ...
            <table style="width:16.4cm; margin-top:3cm;">
                <tr>
