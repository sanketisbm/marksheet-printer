...
<div class="marksheet mb-0 margin-0-5" style="margin-top:0.5cm;width: 18.92cm !important;">
    <?php
    $subCount = $no_of_exams;

    if ($subCount === "2") {
        $semHeaderClass = "col-2-semHeader";
        $semNoClass = "col-2-semNo";
        $gTClass = "col-2-resDiv";
        $resDivClass = "col-2-resDiv";
    } elseif ($subCount === "3") {
        $semHeaderClass = "col-3-semHeader";
        $semNoClass = "col-3-semNo";
        $gTClass = "col-3-resDiv";
        $resDivClass = "col-3-resDiv";
    } elseif ($subCount === "4") {
        $semHeaderClass = "col-4-semHeader";
        $semNoClass = "col-4-semNo";
        $gTClass = "col-4-resDiv";
        $resDivClass = "col-4-resDiv";
    } elseif ($subCount === "6") {
        $semHeaderClass = "col-6-semHeader";
        $semNoClass = "col-6-semNo";
        $gTClass = "col-6-GT";
        $resDivClass = "col-6-resDiv";
    } elseif ($subCount === "8") {
        $semHeaderClass = "col-8-semHeader";
        $semNoClass = "col-8-semNo";
        $gTClass = "col-8-GT";
        $resDivClass = "col-8-resDiv";
    } elseif ($subCount === "10") {
        $semHeaderClass = "col-10-semHeader";
        $semNoClass = "col-10-semNo";
        $gTClass = "col-10-GT";
        $resDivClass = "col-10-resDiv";
    } else {
    }
    ...
    <table class="mb-2 w-100 font-11pt text-start p-info-mn <?php echo $topSpacing ?>"
        style="width: 18.92cm !important;">
        <tr>
        ...
        <tr>
            ...
            <td class="pn-col-3 text-start">Enrollment No</td>
            <td class="pn-col-4 text-start">:<?php echo  $enrollment_no ?></td>
        </tr>
        <tr>
    ...
    <table class="table table-bordered table-marks mb-0" style="width: 18.92cm !important;">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="column-47 footer-total"
                    style="vertical-align: text-top !important;font-size: 10pt !important;">
                ...
                <td class="column-47 footer-total fw-bold"
                    style="vertical-align: text-top !important;font-size: 10pt !important;">
                    <div style="padding-top: 0.1cm !important;"><?php echo  $total_obt ?></div>
                </td>
                <!-- <td class="column-47 footer-total"><?php echo  $Ext_max_obt_total ?></td>
                <td class="column-47 footer-total"><?php echo  $int_max_total ?></td>
                <td class="column-47 footer-total"><?php echo  $int_max_obt_total ?></td>
                <td class="column-47 footer-total fw-bold"><?php echo  $total_obt ?></td> -->
                <td class="column-47 footer-total"></td>
            </tr>
        </tbody>
    </table>

    <table class="table table-bordered table-marks t-marks-row" style="width: 18.92cm !important;">
        <thead>
            <tr>
                <th class="h-0-5 font-10pt text-start ps-1 border-start-1 <?php echo  $semHeaderClass ?>">SEM/YEAR</th>
                <?php for ($i = 1; $i <= $subCount; $i++) { ?> <th class="h-0-5 font-10pt <?php echo  $semNoClass ?>">
                        <?php echo numberToRoman($i) ?>
                    </th>
                <?php } ?>
                <th class="h-0-5 font-10pt <?php echo  $resDivClass ?>">GRAND TOTAL</th>
                <th class="h-0-5 font-10pt <?php echo  $resDivClass ?>">RESULT</th>
                <th class="h-0-5 font-10pt <?php echo  $resDivClass ?>">DIV</th>
            </tr>
        </thead>
        <tbody>
            <!-- MAX MARKS Row -->
            <tr>
                <th class="h-0-5 font-10pt text-start ps-1 border-start-1 border-top-0 <?php echo  $semHeaderClass ?>">
                    MAX
                    MARKS
                </th>
                <?php for ($i = 1; $i <= $subCount; $i++) { ?>
                    <td class="h-0-5 font-10pt <?php echo  $semNoClass ?>">
                        <?php if (empty(${'sem' . $i . '_max_marks'})) {
                            echo  "-";
                        } else {
                            echo  ${'sem' . $i . '_max_marks'};
                        }
                        ?>
                    </td>
                <?php } ?>
                <td class="h-0-5 font-10pt fw-bold <?php echo  $resDivClass ?>"><?php echo  $cGrand_Total_Max ?></td>
                <td rowspan="2" class="h-0-5 font-10pt fw-bold <?php echo  $resDivClass ?>"><?php echo  $final_result ?>
                </td>
                <td rowspan="2" class="h-0-5 font-10pt fw-bold <?php echo  $resDivClass ?>"><?php echo  $cDivision ?>
                </td>
            </tr>
            <!-- OBTAINED MARKS Row -->
            <tr>
                ...
                <?php for ($i = 1; $i <= $subCount; $i++) { ?> <td class="h-0-5 font-10pt <?php echo  $semNoClass ?>">
                        <?php if (empty(${'sem' . $i . '_max_obt'})) {
                            echo  "-";
                        } else {
                            echo  ${'sem' . $i . '_max_obt'};
                        }
                ...
                <?php } ?>
                <td class="h-0-5 font-10pt fw-bold <?php echo  $resDivClass ?>"><?php echo  $cGrand_Total_Obt ?></td>
            </tr>
        </tbody>
    </table>

    <table style="width: 18.92cm !important;">
        <tr>
            <td style="padding: 0.1cm 0 0 0; display:flex; flex-direction: column;">
                <table style="width: 17.21cm !important;">
                    <tr>
                        <td class="font-11pt text-start fw-bold"
                            style="border:0 !important; padding: 0 0 5px 0 !important">
                            Total Marks Obtained (In words) <span>: <?php echo  $cGrand_Total_Inwords ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 0 5px 0 !important">
                            <table>
                                <tr>
                                    <td class="font-11pt text-start fw-bold w-2-5" style="padding: 0 !important">Date of
                                        Issue</td>
                                    <td class="font-11pt text-start fw-bold" style="padding: 0 !important"> :
                                        <?php echo  $doi ?></td>
                                </tr>
                            </table>
                        </td>
...
<table class="table table-marks table-times-new-roman"
    style="padding: 5px !important;width: 18.92cm !important;margin-top: 0.01cm;position: absolute;bottom: 3.5cm;">
    <?php
    ...
    ?>
    <tr>
        <td class="<?php echo  $preparedBy ?>"
            style="border:0 !important;height: 1.8cm;vertical-align: bottom !important;">
