...
?>
    <div class="doc-container" id="<?= htmlspecialchars($info['enrollment_no']) ?>" style="padding-left: 2.5cm !important;padding-right: 2.5cm !important;">
        <div style="margin-top:5.2cm; display: flex; flex-direction:column;">
            <p style="font-size: 12pt;font-weight: 400;"> S. No.: <?php echo $sl_no ?> </p>
            <p style="font-size: 12pt;font-weight: 400;margin-top:0.5cm;width:16cm;text-align:right;">
            ...
            <p class="text-center" style="margin-top: 1.3cm;font-size: 18pt;font-weight: bold;text-decoration: underline;width:16cm">
                Migration / Transfer / Character Certificate
            </p>
            ...
            <table style="margin-top:1cm;width:16cm">
                <tr>
                    ...
                    <td class="text-start" style="padding-top: 0.3cm !important;border:none !important;font-size:12pt;"><?= htmlspecialchars($resultData['student_name'] ?? $info['student_name'] ?? '-') ?></td>
                </tr>
                <tr>
                    ...
                    <td class="text-start" style="padding-top: 0.3cm !important;border:none !important;font-size:12pt;width:1.3cm">: -</td>
                    <td class="text-start" style="padding-top: 0.3cm !important;border:none !important;font-size:12pt;"><?= htmlspecialchars($resultData['father_name'] ?? $info['father_name'] ?? '-') ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-start" style="padding-top: 0.3cm !important;border:none !important;font-size:12pt;width:1.3cm">: -</td>
                    <td class="text-start" style="padding-top: 0.3cm !important;border:none !important;font-size:12pt;"><?= htmlspecialchars($resultData['enrollment_no'] ?? $info['enrollment_no'] ?? '-') ?></td>
                </tr>
                <tr>
