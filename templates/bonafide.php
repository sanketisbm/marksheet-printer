    ...
    <div style="margin-top:5.2cm; display: flex; flex-direction:column;">
        ...
        <div style="display:flex;flex-direction:column;margin-top:2cm;width:17cm">
            <p style="font-size: 14pt;margin-bottom: 10pt;line-height: 1.25;">
                ...
                a student of <b><?= htmlspecialchars($resultData['program_print_name'] ?? $info['program'] ?? '-') ?></b> in the
                batch of
                <?= htmlspecialchars(explode("-", $resultData['exam_session'])[1] ?? $info['exam_session'] ?? '-') ?>.
            </p>
            <p style="font-size: 14pt;margin-bottom: 10pt;line-height: 1.25;">
                <?= htmlspecialchars($initials ?? 'He/She') ?> is a Bonafide student of ISBM University.
            </p>
            <p style="font-size: 14pt;margin-bottom: 10pt;line-height: 1.25;">
                <?= htmlspecialchars($initials ?? 'He/She') ?> is reliable, sincere, hardworking and bears a good moral character.
            </p>
        </div>
