...
$options->set('margin_left', value: 0);
...
$dompdf->setPaper([0, 0, 605.14, 862.02], 'portrait'); // 21.38 cm x 30.48 cm converted to points
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['content'])) {
    ...
    try {
        ...
        $dompdf->render();
        $pdfOutputPath = "marksheets/" . date('Ymd') . "_" . time() . "_" . 'results.pdf';
